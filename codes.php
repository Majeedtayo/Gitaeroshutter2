...
<html lang="en">
<head>
<title>Sauna a Beauty and spa Category Flat Bootstrap Responsive Website Template | Short Codes :: w3layouts</title>
<!-- for-mobile-apps -->
			     ...
			     <div class="inner-header-agile">	
								<nav class="navbar navbar-default">
									<div class="navbar-header">
										...
										<h1><a  href="index.php"><span>S</span>auna  <p class="s-log">Relaxation</p></a>
			...
			<!--/content-inner-section-->
				<div class="w3_content_agilleinfo_inner">
					...
					<div class="inner-agile-w3l-part-head">
					            <h2 class="w3l-inner-h-title">Short Codes</h2>
		...
		<div class="container">
         <div class="footer-info-agile">
			...
			<div class="w3agile_footer_copy">
				    <p>© 2017 Sauna. All rights reserved | Design by <a href="http://w3layouts.com/">W3layouts</a></p>
			</div>
